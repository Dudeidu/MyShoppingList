...
class IconSearcher {
    private val icons = listOf(
        ...
        Icon("apple", listOf("apple", "apples", "תפוח עץ", "תפוחי עץ", "תפוח", "תפוחים"), R.drawable.icon_apple),
        ...
        Icon("guava", listOf("guava", "guavas", "גויאה", "גויאבות"), R.drawable.icon_guava),
        ...
        Icon("mushroom", listOf("mushroom", "mushrooms", "portabello", "champignon", "chitake", "פטריות" ,"פורטבלו", "שמפיניון", "שיטאקי", "פטריות שיטאקי", "פטריות פורטבלו", "פטריות שמפיניון"), R.drawable.icon_mushroom),
        ...
        Icon("pita", listOf("pita", "pita bread", "taboon bread", "פיתה", "פיתות", "לאפה", "לאפות"), R.drawable.icon_pita_bread),
