...
class IconSearcher {
    private val icons = listOf(
        ...
        Icon("almonds", listOf("almonds", "שקדים"), R.drawable.icon_almonds),
        Icon("aluminum_foil", listOf("aluminum foil", "aluminum", "foil", "אלומיניום", "רדיד אלומיניום"), R.drawable.icon_aluminum_foil),
        Icon("apple_sauce", listOf("applesauce", "רסק תפוחים", "רסק תפוחי עץ"), R.drawable.icon_apple_sauce),
        Icon("apple", listOf("apples", "תפוח עץ"), R.drawable.icon_apple),
        Icon("apricot", listOf("apricots", "משמשים"), R.drawable.icon_apricot),
        ...
        Icon("avocado", listOf("avocado", "אבוקדו"), R.drawable.icon_avocado),
        ...
        Icon("baby_wipes", listOf("baby wipes", "wipes", "wet wipes", "מגבונים", "מגבונים לחים"), R.drawable.icon_baby_wipes),
        ...
        Icon("banana", listOf("bananas", "בננות"), R.drawable.icon_banana),
        ...
        Icon("battery", listOf("battery", "batteries", "סוללות", "בטריות"), R.drawable.icon_battery),
        ...
        Icon("beet", listOf("beets", "סלק"), R.drawable.icon_beet),
        Icon("bell_pepper_green", listOf("green bell pepper", "pepper", "bell pepper", "פלפל ירוק", "גמבה", "פלפל"), R.drawable.icon_bell_pepper_green),
        Icon("birthday_cake", listOf("birthday cake", "cake", "עוגה"), R.drawable.icon_birthday_cake),
        Icon("bleach", listOf("bleach", "cleaning", "אקונומיקה", "מלבין", "מסיר כתמים"), R.drawable.icon_bleach),
        Icon("blood_orange", listOf("blood orange", "תפוז דם", "תפוז אדום"), R.drawable.icon_blood_orange),
        ...
        Icon("bread", listOf("bread", "baguette", "לחם", "בגט", "גבטה", "ג'בטה", "לחמים"), R.drawable.icon_bread),
        ...
        Icon("cabbage", listOf("cabbage", "כרוב", "כרוב חמוץ", "כרוב כבוש"), R.drawable.icon_cabbage),
        ...
        Icon("carrot", listOf("carrots", "גזרים"), R.drawable.icon_carrot),
        ...
        Icon("charcoals", listOf("charcoals", "פחמים"), R.drawable.icon_charcoals),
        Icon("cheese", listOf("cheese", "גבינה", "גבינת"), R.drawable.icon_cheese),
        Icon("cherry", listOf("cherries", "דובדנים"), R.drawable.icon_cherry),
        Icon("cherry_tomato", listOf("cherry tomatoes", "עגבניות שרי"), R.drawable.icon_cherry_tomato),
        Icon("chicken", listOf("whole chicken", "עוף שלם", "כרעיים עוף"), R.drawable.icon_chicken),
        Icon("chicken_breast", listOf("chicken breast", "schnitzel", "שניצל עוף", "חזה עוף"), R.drawable.icon_chicken_breast),
        Icon("chicken_thigh", listOf("chicken thigh", "thighs", "שוקיים עוף"), R.drawable.icon_chicken_thigh),
        ...
        Icon("coke", listOf("coke", "cola", "soda", "קולה", "קולה זירו", "קולה דיאט"), R.drawable.icon_coke),
        Icon("conditioner", listOf("conditioner", "קונדישינר", "מרכך"), R.drawable.icon_conditioner),
        Icon("cookies", listOf("cookies", "עוגיות"), R.drawable.icon_cookies),
        ...
        Icon("crackers", listOf("crackers", "קרקרים", "פריכיות"), R.drawable.icon_crackers),
        Icon("cream_cheese", listOf("cream cheese", "גבינה לבנה", "שמנת", "גבינת סקי"), R.drawable.icon_cream_cheese),
        Icon("cucumber", listOf("cucumbers", "מלפפונים"), R.drawable.icon_cucumber),
        ...
        Icon("dried_fruits", listOf("dried fruits", "raisins", "sunflower seeds", "pumpkin seeds",
            "watermelon seeds", "nigella", "nigella seeds", "פירות יבשים", "תמרים", "תאנים", "משמש מיובש",
            "זרעי חמניה", "זרעי אבטיח", "זרעי דלעת", "צ'יה", "זערי צ'יה", "זערי כוסברה",
            "זרעי אניס", "זרעי פשתן", "קצח", "זרעי קצח"), R.drawable.icon_dried_fruits),
        Icon("durian", listOf("durian", "דוריאן"), R.drawable.icon_durian),
        Icon("eggplant", listOf("eggplants", "aubergine", "חצילים"), R.drawable.icon_eggplant),
        Icon("eggs", listOf("eggs", "ביצים"), R.drawable.icon_eggs),
        ...
        Icon("flour", listOf("flour", "קמח", "קמח לבן", "קמח מלא", "קמח חיטה לבן", "קמח חיטה מלא", "קמח שיפון", "קמח שיפון מלא", "קמח שמרים", "קמח קוסמין", "קמח קוסמין לבן", "סולת חיטה", "קמח תופח", "קמח תירס", "קמח שקדים", "קמח פיצה"), R.drawable.icon_flour),
        ...
        Icon("fruit_pudding", listOf("pudding", "danone", "פודינג", "מילקי", "מעדן", "אקטימל", "יופלה"), R.drawable.icon_fruit_pudding),
        Icon("garlic", listOf("garlic", "שום"), R.drawable.icon_garlic),
        Icon("guava", listOf("guavas", "גויאבות"), R.drawable.icon_guava),
        Icon("granola_bar", listOf("granola bar", "energy bar", "חטיף אנרגיה", "גרנולה"), R.drawable.icon_granola_bar),
        Icon("grapefruit", listOf("grapefruit", "אשכולית", "אשכוליות", "אשכולית אדומה", "פומלה"), R.drawable.icon_grapefruit),
        ...
        Icon("hazelnut", listOf("hazelnut", "nuts", "אגוזי לוז"), R.drawable.icon_hazelnut),
        ...
        Icon("hot_dog", listOf("hotdogs", "קבנוס", "נקניקיות"), R.drawable.icon_hot_dog),
        ...
        Icon("juice", listOf("juice", "orange juice", "apple juice", "grape juice", "מיץ", "מיץ תפוזים", "מיץ תפוחים", "מיץ ענבים", "ויטמינצ'יק", "מיץ פטל"), R.drawable.icon_juice),
        Icon("kebab", listOf("kebab", "קבבים"), R.drawable.icon_kebab),
        ...
        Icon("lemon", listOf("lemons", "לימונים"), R.drawable.icon_lemon),
        ...
        Icon("lime", listOf("limes", "ליים"), R.drawable.icon_lime),
        ...
        Icon("mushroom", listOf("mushroom", "mushrooms", "portabello", "champignon", "chitake", "פטריות" , "פטריות שיטאקי", "פטריות פורטבלו", "פטריות שמפיניון"), R.drawable.icon_mushroom),
        ...
        Icon("nectarine", listOf("nectarine", "נקטרינה"), R.drawable.icon_nectarine),
        ...
        Icon("orange", listOf("orange", "oranges", "orange", "clementine", "תפוז", "תפוזים", "קלמנטינה", "קלמנטינות"), R.drawable.icon_orange),
        ...
        Icon("pastry", listOf("pastry", "cinnamon roll", "croissant", "baklava", "מאפים", "קרואסון", "קרואסונים", "בקלוואה"), R.drawable.icon_pastry),
        Icon("peach", listOf("peaches", "אפרסקים"), R.drawable.icon_peach),
        ...
        Icon("pecan", listOf("pecan", "pecans", "אגוזי פקאן", "פקאנים"), R.drawable.icon_pecan),
        ...
        Icon("pepsi", listOf("pepsi", "soda", "פפסי", "סודה", "פפסי מקס", "פפסי דיאט"), R.drawable.icon_pepsi),
        ...
        Icon("pickles", listOf("pickles", "מלפפונים חמוצים", "חמוצים"), R.drawable.icon_pickles),
        Icon("pie", listOf("pie", "פאי"), R.drawable.icon_pie),
        Icon("pineapple", listOf("pineapple", "אננס"), R.drawable.icon_pineapple),
        Icon("pistachio", listOf("pistachio", "אגוזי פיסטוק", "פיסטוקים"), R.drawable.icon_pistachio),
        Icon("pita", listOf("pita", "pita bread", "taboon bread", "פיתות", "לאפה", "לאפות"), R.drawable.icon_pita_bread),
        Icon("pizza", listOf("pizza", "פיצה"), R.drawable.icon_pizza),
        ...
        Icon("plum", listOf("plum", "plums", "שזיפים"), R.drawable.icon_plum),
        Icon("pomegranate", listOf("pomegranate", "רימונים"), R.drawable.icon_pomegranate),
        Icon("popcorn", listOf("popcorn", "פופקורן"), R.drawable.icon_popcorn),
        Icon("potato", listOf("potato", "potatoes", "תפוחי אדמה", "תפו\"א"), R.drawable.icon_potato),
        ...
        Icon("rack_of_lamb", listOf("lamb", "כבש", "טלה", "צלעות טלה", "צלעות כבש"), R.drawable.icon_rack_of_lamb),
        Icon("radish", listOf("radish", "radishes", "צנון", "צנוניות"), R.drawable.icon_radish),
        ...
        Icon("red_onion", listOf("red onion", "red onions", "בצל אדום"), R.drawable.icon_red_onion),
        Icon("rice_bowl", listOf("rice", "אורז", "אורז פרסי", "אורז בסמטי", "אורז אדום", "אורז יסמין", "אורז מלא", "אורז עגול", "אורז ריזוטו"), R.drawable.icon_rice_bowl),
        ...
        Icon("salad", listOf("salad", "tuna salad", "egg salad", "סלט", "סלטים", "סלט טונה", "סלט ביצים", "סלט כרוב", "סלט חצילים", "סלט אבוקדו"), R.drawable.icon_salad),
        Icon("salami", listOf("salami", "prosciutto", "deli meat", "pastrami", "נקניק", "נקניקים", "פסטרמה", "סלמי"), R.drawable.icon_salami),
        Icon("salmon", listOf("salmon", "דג סלמון", "סלמון מעושן"), R.drawable.icon_salmon),
        ...
        Icon("sardines", listOf("sardines", "סרדינים"), R.drawable.icon_sardines),
        Icon("sauce", listOf("sauce", "teriyaki sauce",  "רוטב", "טריאקי", "רוטב טריאקי"), R.drawable.icon_sauce),
        ...
        Icon("shrimp", listOf("shrimp", "prawns", "שרימפס", "חסילונים"), R.drawable.icon_shrimp),
        Icon("sliced_bread", listOf("sliced bread", "לחם פרוס", "לחם אחיד פרוס"), R.drawable.icon_sliced_bread),
        ...
        Icon("soda", listOf("soda", "schweppes", "fanta", "dr depper", "sprite", "סודה", "שוופס", "ספרייט", "פאנטה"), R.drawable.icon_soda),
        ...
        Icon("sponge", listOf("sponge", "ספוג רחצה", "ספוג כלים", "ספוג הפלא"), R.drawable.icon_sponge),
        ...
        Icon("strawberries", listOf("strawberries", "strawberry", "תות שדה"), R.drawable.icon_strawberry),
        ...
        Icon("sweet_potato", listOf("sweet potato", "yams", "בטטה"), R.drawable.icon_sweet_potato),
        Icon("taco", listOf("taco", "tacos", "טאקו"), R.drawable.icon_taco),
        Icon("tahini", listOf("tahini", "טחינה"), R.drawable.icon_tahini),
        Icon("tampon", listOf("tampons", "טמפונים"), R.drawable.icon_tampon),
        Icon("tea", listOf("tea", "tea bags", "earl grey", "jasmin", "תה", "ויסוצקי", "יסמין", "ארל גריי"), R.drawable.icon_tea),
        ...
        Icon("tofu", listOf("tofu", "טופו"), R.drawable.icon_tofu),
        Icon("tomato", listOf("tomato", "tomatoes", "tomatos", "עגבניות"), R.drawable.icon_tomato),
        ...
        Icon("walnut", listOf("walnuts", "אגוזי מלך"), R.drawable.icon_walnut),
        Icon("water_bottle", listOf("water", "water bottle", "bottle of water","מים", "בקבוק מים", "נביעות", "מי עדן"), R.drawable.icon_bottle_of_water),
        Icon("watermelon", listOf("watermelon", "אבטיח"), R.drawable.icon_watermelon),
        ...
        Icon("yellow_bellpepper", listOf("yellow bell pepper", "yellow bellpepper", "פלפל צהוב"), R.drawable.icon_yellow_bell_pepper),
        Icon("yellow_onion", listOf("yellow onion", "yellow onions", "בצל", "בצל לבן"), R.drawable.icon_yellow_onion),
        Icon("yogurt", listOf("yogurt", "יוגורט", "יופלה", "יוגורט יווני"), R.drawable.icon_yogurt),
        Icon("ziplock_bag", listOf("ziplock", "zip lock", "שקיות זיפר", "זיפלוק"), R.drawable.icon_ziplock_bag),
        Icon("zucchini", listOf("zucchini", "זוקיני", "קישוא"), R.drawable.icon_zucchini),
    )
    ...
    fun makeWordList() : ArrayList<String> {
        ...
        return ArrayList<String>(baseWordSet.sorted())
    }
    ...
    fun updateAutofillWords(itemList: MutableList<Item>) {
        ...
        //Log.d("ITEM", "updateAutofillWords: ${totalWordsSet.size}")
    }
